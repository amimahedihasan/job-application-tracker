...
// Function to calculate and update job counts
...
// Function to toggle button styles and filter views
function toggleStyle(id) {
    ...
    // Handle section visibility and rendering based on ID
...
// Event listener for Interview, Rejected, and Delete buttons
...
// Function to render the Interview list
...
// Function to render the Rejected list
